...
public class EmailManager {
    ...
    public static String username = "17782271150@163.com"; // 服务邮箱(from邮箱)
    public static String password = "982155420welk"; // 邮箱密码
    public static String senderNick = "刘lk";   // 发件人昵称
     ...
     * @return
     */
    public boolean sendMail(String from, List to, List copyto, String subject, String content, List fileList) throws Exception {
...
//          mimeMsg.setFrom(new InternetAddress(from));
            ...
            if (fileList != null && fileList.size() > 0) {
                for (int i = 0; i < fileList.size(); i++) {
                    bp = new MimeBodyPart();
                    FileDataSource fds = new FileDataSource(fileList.get(i).toString());
...
//              transport.sendMessage(mimeMsg, mimeMsg.getRecipients(Message.RecipientType.CC));
     ...
     * @return
     */
    public boolean sendMail(String from, String to, String cc, String subject, String content, List fileList) {
        boolean success = true;
        try {
            mimeMsg = new MimeMessage(session);
            mp = new MimeMultipart();
...
//          mimeMsg.setFrom(new InternetAddress(from));
    ...
    public String getMailList(List mailArray) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        to.add("982155420@qq.com");
        List copyto = new ArrayList<String>();
        copyto.add("982155420@qq.com");
        String subject = "测试一下";
        String content = "这是邮件内容，仅仅是测试，不需要回复.";
        List fileList = new ArrayList<String>();
//        fileList.add("D:/新建文件夹/1.txt");
//        fileList.add("D:/新建文件夹/2.txt");
//        fileList.add("D:/新建文件夹/a.png");
        boolean aa = EmailManager.getInstance().sendMail(from, to, copyto, subject, content, fileList);
